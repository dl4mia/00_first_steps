...
Welcome to the DL4MIA 2023 first exercise: 00 - First steps. In this set of exercises, we will ease out into scientific use of Python for image anaysis by manipulating a stack of images, saving and loading it. Additional optional exercises are available in the exercise sheet for those who are fast!
